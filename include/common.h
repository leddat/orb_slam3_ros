...
extern ros::Publisher pose_pub, odom_pub, kf_markers_pub, odom_orb_pub;
...
void setup_publishers(ros::NodeHandle&, image_transport::ImageTransport&, std::string, Eigen::Vector3d = Eigen::Vector3d::Zero());
...
void publish_tf_to_base_transform(Sophus::SE3f, string, string, ros::Time);
void publish_body_odom(Sophus::SE3f, Eigen::Vector3f, Eigen::Vector3f, ros::Time);
void publish_orb_odom(Sophus::SE3f, ros::Time);
...
tf::Transform SE3f_to_tfBaseTransform(Sophus::SE3f);
